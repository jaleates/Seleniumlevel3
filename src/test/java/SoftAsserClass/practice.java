...
public class practice {
    ...
    public void practice1(){
        ...
        softAssert.assertEquals(BrowserUtils.getText(message2),"You pressed Cancel in confirmation popup");
        ...
        softAssert.assertEquals(BrowserUtils.getText(message3),"You entered text Accepted in propmt popup");
