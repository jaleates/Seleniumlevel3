...
public class DragandDrop {
    ...
    public void dragandDrop(){
        ...
        String actualmaasage= BrowserUtils.getText(orangebox);
...
String actual= BrowserUtils.getText(afterecute);
...
Assert.assertEquals(actual,expected);
    ...
    public void DargAndDropPractice(){
        ...
        String actual= BrowserUtils.getText(bliebox);
        ...
        String actualafteraction= BrowserUtils.getText(bliebox);
    ...
    public void PracticeDragandDrop(){
       ...
       String actualtext= BrowserUtils.getText(Drophere);
...
String actualmassage= BrowserUtils.getText(Drophere);
...
@Test
    ...
    action.clickAndHold(notAccept).moveToElement(dropHere).release().perform();
      // dropHere=driver.findElement(By.xpath("//div[@class='accept-drop-container']//div[@id='droppable']"));
       ...
       String Afterdragactual= BrowserUtils.getText(dropHere);
